  ...
  if not gfile.Exists(vocabulary_path):
    ...
    with gfile.GFile(data_path, mode="rb") as f:
      ...
      for line in f:
        ...
        line = tf.compat.as_bytes(line) if tokenizer is None else line
    ...
    with gfile.GFile(data_path, mode="rb") as data_file:
      with gfile.GFile(target_path, mode="w") as tokens_file:
        ...
        for line in data_file:
          ...
          token_ids = sentence_to_token_ids(tf.compat.as_bytes(line) if tokenizer is None else line, vocab,
...
def prepare_wmt_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  train_path = ''
  dev_path = ''
  from_train_path = train_path + "training.en"
  to_train_path = train_path + "training.jp"
  from_dev_path = dev_path + "valid.en"
  to_dev_path = dev_path + "valid.jp"
...
def prepare_data(data_dir, from_train_path, to_train_path, from_dev_path, to_dev_path, from_vocabulary_size,
  ...
  create_vocabulary(to_vocab_path, to_train_path , to_vocabulary_size, japanese_tokenizer)
  ...
  data_to_token_ids(to_train_path, to_train_ids_path, to_vocab_path, japanese_tokenizer)
  data_to_token_ids(from_train_path, from_train_ids_path, from_vocab_path, tokenizer)

  # Create token ids for the development data.
  to_dev_ids_path = to_dev_path + (".ids%d" % to_vocabulary_size)
  from_dev_ids_path = from_dev_path + (".ids%d" % from_vocabulary_size)
  data_to_token_ids(to_dev_path, to_dev_ids_path, to_vocab_path, japanese_tokenizer)
...
if __name__ == '__main__':
    create_vocabulary('vocab_jp.to', 'training.en', 40000, tokenizer=None)
    pass
